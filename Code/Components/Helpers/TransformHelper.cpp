...
namespace
{
	static void RegisterTransformHelperComponent(Schematyc::IEnvRegistrar& registrar)
	{
		Schematyc::CEnvRegistrationScope scope = registrar.Scope(IEntity::GetEntityScopeGUID());
		{
			...
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CTransformHelperComponent::GetComponentTransform, "{9B5D0952-3E2E-4660-A46B-CB4D9448EB31}"_cry_guid, "Get Component Transform");
			...
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CTransformHelperComponent::SetComponentTransform, "{B8D26FBB-D698-4B04-8FF2-47C8CD3B10E2}"_cry_guid, "Set Component Transform");
				pFunction->BindInput(1, 'idx', "Component Index");
